...
def evaluate(weight_file_path, input_filename, output_dir, prob_thresh=0.5, nms_thresh=0.1, lw=3, display=False):
...
def main():
  ...
  argparse.add_argument('--input_filename', type=str, help='Image data directory.', default="/path/to/input_image_directory")
  ...
  assert os.path.exists(args.input_filename), "data directory: " + args.input_filename + " not found."
  ...
  with tf.Graph().as_default():
    evaluate(
      weight_file_path=args.weight_file_path, input_filename=args.input_filename, output_dir=args.output_dir,
